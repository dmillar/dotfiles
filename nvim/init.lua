...
vim.keymap.set("n", "<leader>p", ":wincmd p<CR>", { noremap = true })
-- Cycle through tabs
vim.keymap.set("n", "<Tab>", ":tabN<CR>", { noremap = true })

-- Toggle neotree --
vim.keymap.set("", "<M-f>", ":Neotree toggle<CR>")

-- Disable deselecting after shifting right or left
